...
| Battery charging | Included, but not yet tested | Not provided for the Acquisition PCB | Not provided |
...
transfer after provisioning. See the [main build instructions](../README.md#build-instructions)
and [ESP32 firmware guide](../fw/esp32/README.md).
